...
router.get("/history", requireViewer, async (req: any, res: Response) => {
  try {
...
router.get("/stats", requireViewer, async (req: any, res: Response) => {
  try {
...
router.delete("/:queryId", requireAdmin, async (req: any, res: Response) => {
  try {
...
router.delete("/", requireAdmin, async (req: any, res: Response) => {
  try {
