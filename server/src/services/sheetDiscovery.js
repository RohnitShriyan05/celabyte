...
exports.sheetDiscoveryService = exports.SheetDiscoveryService = void 0;
...
class SheetDiscoveryService {
     ...
     */
    async discoverAndWhitelistSheets(tenantId, connectionId, sheetsUrl) {
        try {
     ...
     */
    async discoverSheetsFromUrl(sheetsUrl) {
        const sheets = [];
     ...
     */
    async ensureSheetWhitelisted(tenantId, connectionId, sheet) {
     ...
     */
    async addSheetToWhitelist(tenantId, connectionId, sheetIdentifier) {
     ...
     */
    async getWhitelistedSheets(tenantId) {
     ...
     */
    async removeSheetFromWhitelist(tenantId, sheetName) {
...
exports.SheetDiscoveryService = SheetDiscoveryService;
exports.sheetDiscoveryService = new SheetDiscoveryService();
