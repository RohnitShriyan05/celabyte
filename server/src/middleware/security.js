...
exports.validateSchema = exports.requestTimeout = exports.sanitizeInput = exports.validateQuery = exports.analyzeQueryComplexity = exports.tenantRateLimit = void 0;
...
const tenantRateLimit = (maxRequests = 100, windowMs = 60000) => {
    return (req, res, next) => {
        ...
        if (tenantLimit.count >= maxRequests) {
            logger_1.logger.warn({ tenantId, count: tenantLimit.count }, "Tenant rate limit exceeded");
...
const validateQuery = (req, res, next) => {
    try {
        ...
        // Analyze complexity
        const complexity = (0, exports.analyzeQueryComplexity)(message);
        if (complexity.score > security_1.SECURITY.maxQueryComplexity) {
            ...
            return res.status(400).json({
                ...
                maxAllowed: security_1.SECURITY.maxQueryComplexity
            });
        }
        ...
        logger_1.logger.error({ error: error.message }, "Query validation failed");
...
const requestTimeout = (timeoutMs = security_1.SECURITY.queryTimeoutMs) => {
    return (req, res, next) => {
