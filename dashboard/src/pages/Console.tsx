...
export function Console() {
  ...
  const loadConnections = async () => {
    try {
      ...
      const connectedIds = data
        .filter((conn: DatabaseConnection) => conn.status === "connected")
        .map((conn: DatabaseConnection) => conn.id);
      setSelectedConnections(connectedIds);
    } catch (err) {
      toast({
        title: "Couldn't load databases",
        description:
          "Something went wrong while loading your databases. Please check your internet connection or try refreshing the page.",
        variant: "destructive",
      });
    } finally {
  ...
  const loadConversations = async () => {
    try {
      ...
      toast({
        ...
        description:
          "We couldn't load your chat history. Please try again later.",
        variant: "destructive",
      });
    }
  };
  ...
  const loadMessages = async (conversationId: string) => {
    try {
      ...
      toast({
        ...
        description:
          "We couldn't load your conversation. Please try again or start a new chat.",
        variant: "destructive",
      });
    }
  };
  ...
  const loadQueryHistory = async () => {
    try {
      ...
      toast({
        ...
        description:
          "We couldn't load your recent queries. Please refresh the page or try again later.",
        variant: "destructive",
      });
    }
  };
  ...
  const createNewChat = async () => {
    try {
      ...
      toast({
        ...
        description:
          "We couldn't start a new chat. Please check your connection and try again.",
        variant: "destructive",
      });
    }
  };
  ...
  const sendChatMessage = async () => {
    ...
    try {
      ...
      setError(
        "Sorry, we couldn't send your message. Please check your connection or try again."
      );
  ...
  const handleRunQuery = async () => {
    ...
    try {
      ...
      const selectedDbs = connections.filter((conn) =>
      ...
      const enhancedMessage = `Context: I have access to ${
        contextInfo.totalDatabases
      } database(s) of types: ${contextInfo.databaseTypes.join(
        ", "
      )}. Available databases: ${contextInfo.availableDatabases
...
Please provide a specific, actionable response. If you need more information about table structures or column names, ask specific questions about which database and table you should examine.`;
      ...
      const errorMessage =
        "Sorry, we couldn't process your request. Please check your question or try again in a few moments.";
      ...
      <div className="space-y-4 sm:space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            ...
            <Button
              variant="outline"
              onClick={isChatMode ? loadConversations : loadQueryHistory}
              className="w-full sm:w-auto"
            >
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Select which databases to query ({selectedConnections.length} of{" "}
                ...
                <Card>
                  <CardHeader className="flex flex-row items-center justify-between">
                    <div>
                      ...
                      <CardDescription>
                        {results.rows ? `${results.rows} rows` : "No data"}{" "}
                        returned in {results.duration || 0}ms
