    ...
    try {
      ...
      if (testMode) {
        toast({
          ...
          description: `Found ${
            result.matchedLeads || result.totalLeads
          } matching leads`,
        });
      } else {
        toast({
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
          <div>
            ...
            <p className="text-gray-600 text-sm sm:text-base">
              Send AI-powered email campaigns to your leads
            </p>
          </div>
        </div>
        ...
        {analytics && (
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {analytics.summary.sentEmails.toLocaleString()}
                </div>
              </CardContent>
            </Card>
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {analytics.summary.failedEmails.toLocaleString()}
                </div>
              </CardContent>
            </Card>
            <Card>
          ...
          <TabsContent value="send" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Use natural language to describe which leads should receive
                  your email. Our AI will interpret your criteria and find
                  matching leads.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Label>
                    Test Mode (Preview matching leads without sending emails)
                  </Label>
                </div>
                  ...
                  <Alert>
                    ...
                    <AlertDescription>
                      <div className="space-y-2">
                        ...
                        <p>
                          <strong>Criteria:</strong> {campaignResult.criteria}
                        </p>
                        <div className="grid grid-cols-3 gap-4 mt-3">
                          <div className="text-center">
                            <div className="text-2xl font-bold text-blue-600">
                              {campaignResult.totalLeads}
                            </div>
                        ...
                        {testMode && campaignResult.totalLeads > 0 && (
                          <div className="mt-3 p-3 bg-blue-50 rounded-lg">
                            <p className="text-sm text-blue-800">
                              ✓ Found {campaignResult.totalLeads} matching
                              leads. Turn off test mode to send emails.
                            </p>
                          </div>
                        )}
                      </div>
                      ...
                      {logs.length === 0 ? (
                        <TableRow>
                          <TableCell colSpan={6} className="text-center py-8">
                            No email logs found. Send your first campaign to see
                            logs here.
                          </TableCell>
                        </TableRow>
                      ) : (
                          ...
                          >
                            ...
                            <div className="flex items-center gap-2">
                              <Progress
                                value={
                                  (stat._count /
                                    (analytics.templateStats[0]?._count || 1)) *
                                  100
                                }
                                className="w-24"
                              />
              ...
              {analytics?.dailyStats && analytics.dailyStats.length > 0 && (
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Email sending activity over the past 30 days
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
